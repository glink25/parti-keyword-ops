...
app.innerHTML = `
  <main class="game-shell">
    ...
    <section class="status-row"><div id="teamSummary" class="team-summary"></div><div id="notice" class="notice"></div></section>
    ...
    <section id="game" class="game hidden">
      ...
      <div id="board" class="board" aria-label="关键词棋盘"></div><aside id="history" class="history"></aside>
    </section>
...
app.addEventListener('click', (event) => {
  ...
  const target = origin && origin.closest ? origin.closest('[data-action], [data-card]') : null;
...
app.addEventListener('submit', (event) => {
  ...
  const wordInput = document.querySelector('#clueWord');
  const countInput = document.querySelector('#clueCount');
